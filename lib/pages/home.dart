                  ...
                  Row(children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                        Text(AppLocalizations.of(context).locationText,
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 16,
                          fontWeight: FontWeight.w500
                        ),),
                        Text(AppLocalizations.of(context).locationTextUnder,
                            style: TextStyle(
                        ...
                        return SingleChildScrollView(
                          child: Padding(
                            ...
                            child: Column(children: [
                                    ...
                                    Container(
                                      child: Stack(
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Row(children: [
                                                  Text(AppLocalizations.of(context).offerTitleFirst,
                                                    style: TextStyle(
                                                        color: Colors.white,
                                                        fontSize: 18,
                                                        fontWeight: FontWeight.w500
                                                  ...
                                                  SizedBox(width: 3),
                                                  Text(AppLocalizations.of(context).offerTitleSecond,
                                                    style: TextStyle(
                                                        color: Colors.white,
                                                        fontSize: 18,
                                              ...
                                              Padding(
                                                ...
                                                child: Text(AppLocalizations.of(context).offerDescription,
                                                  style: TextStyle(
                                                      color: Colors.white,
                                                      fontSize: 11,
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.fromLTRB(145, 38, 0, 0),
                                            ...
                                            child: Center(
                                                child: Row(children: [
                                                  Padding(
                                                    ...
                                                    child: Image.asset(A.carLogo1),
                                                  ),
                                                  Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                    Padding(
                                                      padding: const EdgeInsets.fromLTRB(7,9, 0, 0),
                                                      child: Text(
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        padding: const EdgeInsets.only(left: 7),
                                                        child: Text(
                                                            AppLocalizations.of(context).wash,
                                                            style: TextStyle(
                                                                fontSize: 15,
                                                                fontWeight: FontWeight.bold,
                                                                color: Colors.black)
                              ...
                              Row(
                                children: [
                                  Text(AppLocalizations.of(context).topService,
                                    style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold
                                    ),),
